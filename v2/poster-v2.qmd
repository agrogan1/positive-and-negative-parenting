---
title: "Same Same; Different Different: Universals, Commonality, Diversity and Variation In Parenting and Child Development" 
author: 
...
bibliography: poster-v2.bib
csl: apa.csl
citation:
  url: https://agrogan1.github.io/
  container-title: "Michigan Momentum: Showcasing the Cutting Edge of Social Work Science"
from: markdown+emoji
filters:
  - highlight-text
---
...
::: {.incremental}
* [UNICEF considers children globally to be in crisis]{color="#FF0000"}: political violence, climate change, and poverty affect many children [@UNICEF2024fastfacts; @UNICEF2024notnewnormal].
* In this time of crisis, [parenting]{color="#FF0000"} is one crucial area of focus.
* According to UNICEF data, [$\frac{1}{3}$ of children are subject to physical punishment]{color="#FF0000"} [@Ward2023]; [$\frac{2}{3}$ to some form of violent punishment]{color="#FF0000"} [@UNICEF2024fastfacts].
