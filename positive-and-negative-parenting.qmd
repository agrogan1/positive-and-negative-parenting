...
<button onclick="typeWriter()">Click To See The Challenge</button>

<p id="demo" style="color:red;font-family: monospace;"></p>

<script>
var i = 0;
var txt = 'Thinking about universals, commonality and similarity is difficult, yet, I would argue vital. Finding the best way to talk about these ideas, statistically model them, and visualize them, is challenging. Comments, questions, and suggestions are welcome.';
var speed = 50;
